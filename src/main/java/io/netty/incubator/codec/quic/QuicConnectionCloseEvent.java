...
/**
 * Event that is generated if the remote peer sends a CLOSE_CONNECTION. This allows to inspect the
 * {@link #error()} and so see if the close was done because of an error or not.
 */
public final class QuicConnectionCloseEvent implements QuicEvent {
     ...
     * contains a {@code TLS error} it will return {@code -1}.
     *
